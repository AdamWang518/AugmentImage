...
public class DepartmentButton {
    ...
    String Type="180C275A-0AA8-4C47-B940-8E675FBB7C8B";
    ...
    public void getDepartment(){
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url + "getDepartments?Institude=工學院&TypeID=180C275A-0AA8-4C47-B940-8E675FBB7C8B", new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray jsonArray) {
                Log.d("leolog",String.valueOf(jsonArray));
            }
        },null);
